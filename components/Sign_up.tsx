                ...
                <ScrollView>
                    ...
                    <View style={style.bloc2}>
                        ...
                        <View style={style.bottom}>
                            <TouchableOpacity style={style.button_log} onPress={() => Alert.alert('Simple Button pressed')}>
                                <Text style={{color : '#ecf0f1', textAlign:'center', fontSize : 18}}>Confimer</Text>
                            </TouchableOpacity>
                            <View style={{paddingTop : 20}}>
                            <TouchableOpacity style={style.button_sign} onPress={() => Alert.alert('Simple Button pressed')}>
